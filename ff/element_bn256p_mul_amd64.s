...
// func fromMontelement_bn256p(res *element_bn256p)
// montgomery multiplication of res by 1 
// stores the result in res
TEXT ·fromMontelement_bn256p(SB), NOSPLIT, $0-8
	// the algorithm is described here
	// https://hackmd.io/@zkteam/modular_multiplication
	// when y = 1 we have: 
	// for i=0 to N-1
...
// func reduceelement_bn256p(res *element_bn256p)
TEXT ·reduceelement_bn256p(SB), NOSPLIT, $0-8
	// test purposes
