...
func mulAssignelement_bn256p(z, x Element) {
	...
	}
	{
		...
		c[2] = madd0(m, 4891460686036598785, c[0])
		c[1], c[0] = madd2(v, xar[1], c[1], t[1])
		c[2], zar[0] = madd2(m, 2896914383306846353, c[2], c[0])
		c[1], c[0] = madd2(v, xar[2], c[1], t[2])
	...
	// if z > q --> z -= q
	// note: this is NOT constant time
	if !(zar[3] < 3486998266802970665 || (zar[3] == 3486998266802970665 && (zar[2] < 13281191951274694749 || (zar[2] == 13281191951274694749 && (zar[1] < 2896914383306846353 || (zar[1] == 2896914383306846353 && (zar[0] < 4891460686036598785))))))) {
		var b uint64
		zar[0], b = bits.Sub64(zar[0], 4891460686036598785, 0)
		zar[1], b = bits.Sub64(zar[1], 2896914383306846353, b)
...
func fromMontelement_bn256p(z *element_bn256p) {
...
// for test purposes
func reduceelement_bn256p(z *element_bn256p) {
