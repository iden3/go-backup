...
func TestELEMENT_BN256QCorrectnessAgainstBigInt(t *testing.T) {
	...
	for i := 0; i < n; i++ {
		...
		var e1, e2, eMul, eAdd, eSub, eDiv, eNeg, eLsh, eInv, eExp, eSquare, eMulAssign, eSubAssign, eAddAssign element_bn256q
		e1.SetBigInt(b1)
		e2.SetBigInt(b2)
		...
		if n <= 5 {
			// sqrt
			var eSqrt, eExp2 element_bn256q
			var bSqrt big.Int
...
func TestELEMENT_BN256QIsRandom(t *testing.T) {
	for i := 0; i < 50; i++ {
		var x, y element_bn256q
		x.SetRandom()
		y.SetRandom()
		if x.Equal(&y) {
...
var benchReselement_bn256q element_bn256q

func BenchmarkInverseELEMENT_BN256Q(b *testing.B) {
	var x element_bn256q
	x.SetRandom()
	benchReselement_bn256q.SetRandom()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		benchReselement_bn256q.Inverse(&x)
	}

}
func BenchmarkExpELEMENT_BN256Q(b *testing.B) {
	var x element_bn256q
	x.SetRandom()
	benchReselement_bn256q.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchReselement_bn256q.Exp(&x, mrand.Uint64())

	}
}

func BenchmarkDoubleELEMENT_BN256Q(b *testing.B) {
	benchReselement_bn256q.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchReselement_bn256q.Double(&benchReselement_bn256q)
	}
}

func BenchmarkAddELEMENT_BN256Q(b *testing.B) {
	var x element_bn256q
	x.SetRandom()
	benchReselement_bn256q.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchReselement_bn256q.Add(&x, &benchReselement_bn256q)
	}
}

func BenchmarkSubELEMENT_BN256Q(b *testing.B) {
	var x element_bn256q
	x.SetRandom()
	benchReselement_bn256q.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchReselement_bn256q.Sub(&x, &benchReselement_bn256q)
	}
}

func BenchmarkNegELEMENT_BN256Q(b *testing.B) {
	benchReselement_bn256q.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchReselement_bn256q.Neg(&benchReselement_bn256q)
	}
}

func BenchmarkDivELEMENT_BN256Q(b *testing.B) {
	var x element_bn256q
	x.SetRandom()
	benchReselement_bn256q.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchReselement_bn256q.Div(&x, &benchReselement_bn256q)
	}
}

func BenchmarkFromMontELEMENT_BN256Q(b *testing.B) {
	benchReselement_bn256q.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchReselement_bn256q.FromMont()
	}
}

func BenchmarkToMontELEMENT_BN256Q(b *testing.B) {
	benchReselement_bn256q.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchReselement_bn256q.ToMont()
	}
}
func BenchmarkSquareELEMENT_BN256Q(b *testing.B) {
	benchReselement_bn256q.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchReselement_bn256q.Square(&benchReselement_bn256q)
	}
}

func BenchmarkSqrtELEMENT_BN256Q(b *testing.B) {
	var a element_bn256q
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchReselement_bn256q.Sqrt(&a)
	}
}

func BenchmarkMulAssignELEMENT_BN256Q(b *testing.B) {
	x := element_bn256q{
	...
	benchReselement_bn256q.SetOne()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchReselement_bn256q.MulAssign(&x)
	}
}

/*

func BenchmarkMulAssignASMELEMENT_BN256Q(b *testing.B) {
	x := element_bn256q{
		17522657719365597833,
		13107472804851548667,
		5164255478447964150,
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		MulAssignelement_bn256q(&benchReselement_bn256q, &x)
	}
}


func BenchmarkSquareASMELEMENT_BN256Q(b *testing.B) {
	benchReselement_bn256q = element_bn256q{
		17522657719365597833,
		13107472804851548667,
		5164255478447964150,
		493319470278259999,
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Squareelement_bn256q(&benchReselement_bn256q, &benchReselement_bn256q)
	}
}
...
func TestELEMENT_BN256QAsm(t *testing.T) {
	...
	for i := 0; i < 500; i++ {
		...
		// e1 = mont(b1), e2 = mont(b2)
		var e1, e2, eTestMul, eMulAssign, eSquare, eTestSquare element_bn256q
		e1.SetBigInt(b1)
		e2.SetBigInt(b2)
...
func (z *element_bn256q) testMulAssign(x *element_bn256q) *element_bn256q {
...
func (z *element_bn256q) testSquare(x *element_bn256q) *element_bn256q {
