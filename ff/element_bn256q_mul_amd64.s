...
TEXT ·mulAssignelement_bn256q(SB), NOSPLIT, $0-16
...
// func fromMontelement_bn256q(res *element_bn256q)
// montgomery multiplication of res by 1 
// stores the result in res
TEXT ·fromMontelement_bn256q(SB), NOSPLIT, $0-8
	// the algorithm is described here
	// https://hackmd.io/@zkteam/modular_multiplication
	// when y = 1 we have: 
	// for i=0 to N-1
...
// func reduceelement_bn256q(res *element_bn256q)
TEXT ·reduceelement_bn256q(SB), NOSPLIT, $0-8
	// test purposes
