...
var _element_bn256qModulusBigInt big.Int
var onceelement_bn256qModulus sync.Once

func element_bn256qModulusBigInt() *big.Int {
	onceelement_bn256qModulus.Do(func() {
		_element_bn256qModulusBigInt.SetString("21888242871839275222246405745257275088696311157297823662689037894645226208583", 10)
	})
	return &_element_bn256qModulusBigInt
}
