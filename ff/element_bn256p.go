...
var _element_bn256pModulusBigInt big.Int
var onceelement_bn256pModulus sync.Once

func element_bn256pModulusBigInt() *big.Int {
	onceelement_bn256pModulus.Do(func() {
		_element_bn256pModulusBigInt.SetString("21888242871839275222246405745257275088548364400416034343698204186575808495617", 10)
	})
	return &_element_bn256pModulusBigInt
}
