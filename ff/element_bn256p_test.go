...
func BenchmarkMulAssignASMELEMENT_BN256P(b *testing.B) {
	x := element_bn256p{
		1997599621687373223,
		6052339484930628067,
		10108755138030829701,
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		MulAssignelement_bn256p(&benchReselement_bn256p, &x)
	}
}


func BenchmarkSquareASMELEMENT_BN256P(b *testing.B) {
	benchReselement_bn256p = element_bn256p{
		1997599621687373223,
		6052339484930628067,
		10108755138030829701,
		150537098327114917,
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		Squareelement_bn256p(&benchReselement_bn256p, &benchReselement_bn256p)
	}
}
